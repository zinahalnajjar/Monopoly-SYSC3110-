...
/**
 * Property tile that holds the cyan color set with their defined constant rent and cost
 *
 * @author Tooba
 */
public class CyanPropertyTile implements Property {

    //Holds the constant properties of the class
    private final int HOUSE_COST = 50;
    private final int INIT_COST = 100;
    private final int INIT_RENT = 6;
     ...
     */
    public CyanPropertyTile(String name, boolean endSet){
        this.tileName = name;
        this.endSet = endSet;
        this.owner = null;
